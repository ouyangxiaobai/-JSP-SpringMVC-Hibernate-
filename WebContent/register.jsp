...
<body>
	...
	<form action="<%=basePath%>saveUser.html">
		<div class="row">
			<div class="col-sm-2"></div>
			<div class="col-sm-8"> 
				<div class="row">
					<div class="col-sm-12">
						<input type="text" name="account"  style="padding-left:10px;border:solid 1px #CCC;width:30%; height:45px; margin-bottom:30px;" placeholder="请输入用户名"/>
					</div>
					<div class="col-sm-12">
						<input type="password" name="password" style="padding-left:10px;border:solid 1px #CCC;width:30%; height:45px; margin-bottom:30px;" placeholder="请输入密码"/>
					</div> 
					<div class="col-sm-12">
						<input type="submit" style="border:none; background:#1E9FD9; color:#FFF; width:100px; height:40px;" value="注册" />
					</div> 
				</div> 
