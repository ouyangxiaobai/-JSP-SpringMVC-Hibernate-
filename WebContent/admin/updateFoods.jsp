    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default wk-panel ">
                ...
                <form action="<%=basePath%>/editFood/${food.id}.html" method="POST">
                            ...
                            <div class="form-group">
                                <label  class="control-label wk-filed-label">美食名称: </label>
                                 <div class="input-group">
                                    <input required="required" value="${food.name}" name="name" type="text" class="form-control wk-normal-input" id="mark" placeholder="请输入美食名称"/>
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    <select class="wk-select" name="item.id">
                                    	<c:forEach items="${items}" var="var">
											<c:choose>
								          		<c:when test="${var.id == food.item.id}">
